...
<body>
    <form id="form1" runat="server">
      <%--  <div>
        ...
        <div style="background-color: #ebf6f9; text-align: center; width: 700px" id="divEmplDetails" runat="server" visible="false">
            ...
            <div>
                <asp:GridView OnRowDataBound="gdImprset_RowDataBound" runat="server" ID="gdImprset"
                    AutoGenerateColumns="false" Width="100%" BorderColor="Black" HeaderStyle-BackColor="Blue"
